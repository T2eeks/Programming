namespace ObjectOrientedPractics
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            OrderTab.Controls.Add(tabPage5);
